...
<!DOCTYPE html>
<html>
<title>E-NoticeBoard | Update Account</title>
...
<li class="w3-right"><a class="w3-green" href="logout.php">Logout (<?php echo"$current"; ?>)</a></li>
  ...
  <div class="container">
<h2 align="center" class="w3-light-grey"><b>Update Account - <?php echo"$myusername"; ?></b></h2>
<form action="update_acc.php" method="POST">
<table align="center">
<br>
  <p>
  <tr><td><label>Update Full Name</label></td>
  <td><input  name="fullname" type="text"  placeholder="Enter Full Name" value="<?php echo"$fullname"; ?>"required></p></td></tr>
    <tr><td><label><b>Update Gender</b></label></td>
 <td> <input  name="gender" type="text"  placeholder="Enter Gender" value="<?php echo"$gender"; ?>"required></p></td></td>
<tr><td>
    <label><b>Update Address</b></label></td>
 <td> <input  name="address" type="text"  placeholder="Enter Address" value="<?php echo"$address"; ?>"required></p></td></tr>
<tr><td>
       <label><b>Update Username</b></label></td>
  <td><input  name="username" type="text"  placeholder="Enter Username" value="<?php echo"$myusername"; ?>"required></p></td></tr>
<tr><td>
    <label><b>Update Password</b></label></td>
  <td><input  name="password" type="password"  placeholder="Enter Password" value="<?php echo"$mypassword"; ?>"required></p></td></tr>
<input type="hidden" name="id" value="<?php echo"$userid"; ?>">
   <tr><td> <button type="submit" class="w3-btn w3-blue">Update Account</button></td></tr>
   </table>
   </form>
   </div>
